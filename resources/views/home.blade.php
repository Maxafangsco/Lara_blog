  ...
  <div class="row">
    ...
    <div class="col-12 col-md-6">
      ...
      <div class="event_right2">
        <div class="pl-5 pt-3 event-title">
          <h3 pt-3>Upcoming events</h3>
        </div>
        <!-- event title -->
        <ul>
          <li>
            <div class="ml-5 singel-event">
          ...
          <li>
            <div class="ml-5 pb-4 singel-event">
...
<video controls autoplay>
  <source src="https://www.youtube.com/watch?v=jh3k1b30l4Q" type="video/mp4"/>
